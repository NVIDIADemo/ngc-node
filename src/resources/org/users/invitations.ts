...
export class Invitations extends APIResource {
  ...
  list(
    ...
    return this._client.getAPIList(
      `/v2/org/${orgName}/users/invitations`,
  ...
  delete(
    ...
    return this._client.delete(`/v2/org/${orgName}/users/invitations/${id}`, options);
  }
   ...
   * required).
   */
  inviteResend(orgName: string, id: string, options?: Core.RequestOptions): Core.APIPromise<Shared.User> {
    return this._client.get(`/v2/org/${orgName}/users/invitations/${id}/resend-invitation-email`, options);
  }
}
