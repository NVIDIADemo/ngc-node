...
export class Users extends APIResource {
  ...
  create(
    ...
    return this._client.post(`/v2/org/${orgName}/team/${teamName}/users`, {
  ...
  retrieve(
    ...
    if (isRequestOptions(query)) {
      return this.retrieve(orgName, teamName, id, {}, query);
    }
    return this._client.get(`/v2/org/${orgName}/team/${teamName}/users/${id}`, { query, ...options });
  }
  ...
  list(
    ...
    return this._client.getAPIList(
      `/v2/org/${orgName}/team/${teamName}/users`,
  ...
  delete(
    ...
    return this._client.delete(`/v2/org/${orgName}/team/${teamName}/users/${id}`, options);
  }
}
