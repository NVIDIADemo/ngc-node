...
describe('resource orgs', () => {
  test('orgOwnerBackfill', async () => {
    const responsePromise = client.superAdminUser.orgs.orgOwnerBackfill('org-name');
  ...
  test('orgOwnerBackfill: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.superAdminUser.orgs.orgOwnerBackfill('org-name', { path: '/_stainless_unknown_path' }),
